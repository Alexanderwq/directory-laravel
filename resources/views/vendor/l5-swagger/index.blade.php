...
<head>
    ...
    @if(config('l5-swagger.defaults.ui.display.dark_mode'))
        <style>
            ...
            #dark-mode .title, #dark-mode li, #dark-mode p, #dark-mode table, #dark-mode label,
            #dark-mode .opblock-tag, #dark-mode .opblock .opblock-summary-operation-id,
            #dark-mode .opblock .opblock-summary-path, #dark-mode .opblock .opblock-summary-path__deprecated,
            ...
            #dark-mode .prop-format,#dark-mode .loading-container .loading:after,
            #dark-mode .opblock-description-wrapper p,#dark-mode .opblock-external-docs-wrapper p,
            #dark-mode .opblock-title_normal p,#dark-mode .response-col_status,#dark-mode table thead tr td,
            #dark-mode table thead tr th,#dark-mode .response-col_links,#dark-mode .swagger-ui { color: wheat; }
...
<script>
    window.onload = function() {
        ...
        const ui = SwaggerUIBundle({
            ...
            oauth2RedirectUrl: "{{ route('l5-swagger.'.$documentation.'.oauth2_callback', [], true) }}",
